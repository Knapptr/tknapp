...
This project was a quick, one-day project. I've done some web-scraping with Python and (Beautiful Soup)[https://www.crummy.com/software/BeautifulSoup/bs4/doc/]. But I was curious about using Node. The (JSDOM)[] module was super easy to get using, as it implements methods available in the browser inside of Node.
