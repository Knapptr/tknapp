...
export const Container = styled.div`
  ${tw`bg-secondary-fill py-6 sm:py-8 px-3 sm:px-7  rounded-lg shadow-lg sm:overflow-auto mb-6`}
`
export const ColContainer = styled.div`
  ${tw` flex flex-col sm:flex-row gap-4 `}
`
export const Header = styled.h2`
  ${tw`font-tmono font-bold text-3xl p-2 md:text-4xl xl:text-5xl`}
`
...
export const Text = styled.p`
  ${tw`font-tsans max-w-prose w-full text-sm md:text-base md:leading-normal xl:text-lg mx-auto mb-4`}
`
...
export const Button = styled.button`
  ${tw`font-tmono bg-tertiary-fill text-tertiary-fg py-2 px-4 border border-tertiary-fg rounded my-6 block shadow-md hover:opacity-75 `}
`
...
export const NavList = styled.ul`
  ${tw`flex flex-row sm:ml-auto gap-4 justify-center order-1 sm:order-none`}
`
export const Nav = styled.nav`
  ${tw`flex flex-col  items-center sm:flex-row px-6 py-5 font-tmono w-full max-w-5xl mx-auto sm:items-baseline gap-4 mb-6 sm:mb-8 md:mb-12 `}
`
